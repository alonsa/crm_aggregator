...
public interface CaseService {
    ...
    void save(List<? extends CrmCase> entities);

    List<CrmCase> getByFilter(CaseStatus status, String providerName, String errorCode);

    LocalDateTime getLastModifiedDateByCrmProducer(CrmProducer crmProducer);
}
